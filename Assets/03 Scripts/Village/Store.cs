...
public class Store : MonoBehaviour
{
    ...
    public void BuyItem_SpeedUp()
    {
        ...
        {
            if (moveSpeed.price > GameManager.Instance.account.gold)
            {
                Debug.Log("돈 부족이요");
            }
            else
    ...
    public void BuyItem_Sandglass()
    {
        if (GameManager.Instance != null)
        {
            if (sandGlass.price > GameManager.Instance.account.gold)
            {
                Debug.Log("골드 부족이요");
            }
            else
    ...
    public void BuyItem_TopTicket()
    {
        if (GameManager.Instance != null)
        {
            if (topTicket.price > GameManager.Instance.account.diamond)
            {
                Debug.Log("다이아 부족이요");
            }
            else
